...
public class LinearProgramming {
	...
	public static void main(String[] args) throws LPException {
		linearProgramming(setProblem());

	}
	public static double[] linearProgramming(LinearProgrammingProblem problem) throws LPException {	
		showProblem(problem);
	...
	public static LinearProgrammingProblem setProblem() {
		...
		problem.numVariables = 4;   // number of variables
...
//		c[0] = -150.0; c[1] = -175.0;                                   // minimize -150*x1 - 175*x2	
		...
		m.set(0,0, 30);  m.set(0,1,-10); m.set(0,2,20); m.set(0,3,-1); m.set(0,4,1);  b[0] = 0;  //  30y1 -10y2 + 20y3 - u + s1 <= 0
		m.set(1,0, -10);  m.set(1,1,20); m.set(1,2,-20); m.set(1,3,-1); m.set(1,5,1);  b[1] = 0;  //  -10y1 + 20y2 - 20y3 - u + s2 <= 0
		m.set(2,0, 1);  m.set(2,1,1); m.set(2,2,1); m.set(2,6,-1);  b[2] = 1;  //  y1 + y2+ y3 + s3<= 1
		m.set(3,0, -1);  m.set(3,1,-1); m.set(3,2,-1); m.set(3,7,1);  b[3] = -1;  //  -y1 - y2 - y3 <= -1
		c[3] = 1;
